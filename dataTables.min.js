...
(function (h) { "function" === typeof define && define.amd ? define(["jquery"], function (E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function (E, H) { E || (E = window); H || (H = "undefined" !== typeof window ? require("jquery") : require("jquery")(E)); return h(H, E, E.document) } : h(jQuery, window, document) })(function (h, E, H, k) {
    ...
    } function Ta(a, b, c) { var d = a._iDisplayStart, e = a._iDisplayLength, f = a.fnRecordsDisplay(); 0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "İlk" == b ? d = 0 : "Geri" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "İleri" == b ? d + e < f && (d += e) : "Son" == b ? d = Math.floor((f - 1) / e) * e : K(a, 0, "Unknown paging action: " + b, 5); b = a._iDisplayStart !== d; a._iDisplayStart = d; b && (r(a, null, "page", [a]), c && P(a)); return b } function rb(a) { return h("<div/>", { id: !a.aanFeatures.r ? a.sTableId + "_processing" : null, "class": a.oClasses.sProcessing }).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0] }
    ...
    }); var Lb = n.ext.pager; h.extend(Lb, { simple: function () { return ["Geri", "İleri"] }, full: function () { return ["İlk", "Geri", "İleri", "Son"] }, numbers: function (a, b) { return [ia(a, b)] }, simple_numbers: function (a, b) { return ["Geri", ia(a, b), "İleri"] }, full_numbers: function (a, b) { return ["İlk", "Geri", ia(a, b), "İleri", "Son"] }, first_last_numbers: function (a, b) { return ["İlk", ia(a, b), "Son"] }, _numbers: ia, numbers_length: 7 }); h.extend(!0, n.ext.renderer, {
        pageButton: {
                    ...
                    var g = a.oClasses, j = a.oLanguage.oPaginate, i = a.oLanguage.oAria.paginate || {}, m, l, n = 0, o = function (b, d) {
                        var k, s, u, r, v = function (b) { Ta(a, b.data.action, true) }; k = 0; for (s = d.length; k < s; k++) {
                            r = d[k]; if (h.isArray(r)) { u = h("<" + (r.DT_el || "div") + "/>").appendTo(b); o(u, r) } else {
                                m = null; l = ""; switch (r) {
                                    case "ellipsis": b.append('<span class="ellipsis">&#x2026;</span>'); break; case "İlk": m = j.sFirst; l = r + (e > 0 ? "" : " " + g.sPageButtonDisabled); break; case "Geri": m = j.sPrevious; l = r + (e > 0 ? "" : " " + g.sPageButtonDisabled); break; case "İleri": m =
                                        j.sNext; l = r + (e < f - 1 ? "" : " " + g.sPageButtonDisabled); break; case "Son": m = j.sLast; l = r + (e < f - 1 ? "" : " " + g.sPageButtonDisabled); break; default: m = r + 1; l = e === r ? g.sPageButtonActive : ""
